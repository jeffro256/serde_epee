...
/*
// Serialize transparently exactly as default, except for Blob
impl serde::Serialize for SectionScalar {
	fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
	where
		S: serde::ser::Serializer,
	{
		match self {
			SectionScalar::Int64(v)      => v.serialize(serializer),
			SectionScalar::Int32(v)      => v.serialize(serializer),
			SectionScalar::Int16(v)      => v.serialize(serializer),
			SectionScalar::Int8(v)       => v.serialize(serializer),
			SectionScalar::UInt64(v)     => v.serialize(serializer),
			SectionScalar::UInt32(v)     => v.serialize(serializer),
			SectionScalar::UInt16(v)     => v.serialize(serializer),
			SectionScalar::UInt8(v)      => v.serialize(serializer),
			SectionScalar::Double(v)     => v.serialize(serializer),
			SectionScalar::Blob(ref v)   => v.serialize(serializer),
			SectionScalar::Str(ref v)    => v.serialize(serializer),
			SectionScalar::Bool(v)       => v.serialize(serializer),
			SectionScalar::Object(ref v) => v.serialize(serializer),
		}
	}
}

// Serialize transparently with seq
impl serde::Serialize for SectionArray {
	fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
	where
		S: serde::ser::Serializer,
	{
		match self {
			SectionArray::Int64(ref v)  => v.serialize(serializer),
			SectionArray::Int32(ref v)  => v.serialize(serializer),
			SectionArray::Int16(ref v)  => v.serialize(serializer),
			SectionArray::Int8(ref v)   => v.serialize(serializer),
			SectionArray::UInt64(ref v) => v.serialize(serializer),
			SectionArray::UInt32(ref v) => v.serialize(serializer),
			SectionArray::UInt16(ref v) => v.serialize(serializer),
			SectionArray::UInt8(ref v)  => v.serialize(serializer),
			SectionArray::Double(ref v) => v.serialize(serializer),
			SectionArray::Bool(ref v)   => v.serialize(serializer),
			SectionArray::Str(ref v)    => v.serialize(serializer),
			SectionArray::Blob(ref v)   => v.serialize(serializer),
			SectionArray::Object(ref v) => v.serialize(serializer)
		}
	}
}

impl serde::Serialize for SectionEntry {
	fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
	where
		S: serde::ser::Serializer,
	{
		match self {
			SectionEntry::Scalar(s) => s.serialize(serializer),
			SectionEntry::Array(a) => a.serialize(serializer)
		}
	}
}*/
